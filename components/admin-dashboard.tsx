                            ...
                            <td className="p-4 text-right">
                              <div className="flex flex-col gap-1.5 items-end">
                                ...
                                <a
                                  ...
                                  className="inline-flex items-center gap-1.5 rounded-md bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-semibold px-2.5 py-1.5 transition-colors"
                                >
                                ...
                                <a
                                  ...
                                  className="inline-flex items-center gap-1.5 rounded-md bg-primary/10 hover:bg-primary/20 text-primary text-xs font-semibold px-2.5 py-1.5 transition-colors"
                                >
                                  <svg className="size-3.5" viewBox="0 0 24 24" fill="currentColor">
                                ...
                                <Button
                                  ...
                                  className="gap-1.5 text-xs h-7 px-2 w-full"
                                  size="xs"
                                  variant="outline"
                                >
